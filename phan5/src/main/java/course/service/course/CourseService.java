...
public class CourseService {
	...
	@Cacheable(value = "courses", key = "#keyword", condition = "#keyword != null") //Cache when keyword != null
	public List<CourseResponseDto> findAllCourseByKeywordName(String keyword) {
		...
		if (courses.isEmpty()) {
			throw new ServiceRuntimeException(
					...
					ErrorCode.COURSE_E001,
					String.format(ErrorMessage.COURSE_E001 + ", keyword: #%s", keyword)
			);
		}
		return courses;
	}

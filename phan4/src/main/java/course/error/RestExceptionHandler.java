...
public class RestExceptionHandler {
    ...
    public ResponseEntity<List<ApiError>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        logError(HttpStatus.BAD_REQUEST, errors.toString());
    ...
    public ResponseEntity<ApiError> handleInvalidFormatException(InvalidFormatException ex) {
        ...
        logError(HttpStatus.INTERNAL_SERVER_ERROR, ErrorMessage.USER_E007);
    ...
    public ResponseEntity<ApiError> handleServiceRuntimeException(ServiceRuntimeException ex) {
        ...
        logError(ex.getHttpStatus(), ex.getMessage());
    ...
    public ResponseEntity<ApiError> handleDataIntegrityViolationException(DataIntegrityViolationException ex) {
        ...
        logError(HttpStatus.BAD_REQUEST, ex.getMessage());
    ...
    public ResponseEntity<ApiError> handleOtherException(Exception ex) {
        ...
        logError(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage());
        return buildResponseEntity(apiError, HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    private void logError(HttpStatus status, String errorMessage) {
        log.error("Status Error: {}, Message: {}", status, errorMessage);
    }
}
